...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo "  RAG_ENABLE_HYDE, RAG_ENABLE_HYDE_VISIBILITY, RAG_HYDE_MAX_TOKENS, RAG_HYDE_TEMPERATURE"
            echo "  RAG_ENABLE_LLM_ANAPHORA, RAG_ANAPHORA_MAX_TOKENS, RAG_ANAPHORA_TEMPERATURE"
            echo "  RAG_RERANKER_MIN_SCORE, RAG_RERANKER_MIN_RESULTS"
            echo ""
            echo "Prerequisites:"
